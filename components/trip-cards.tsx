...
export const SAMPLE_TRIPS: Trip[] = [
  // Weekend Getaways (type: 'weekend') - Maharashtra Treks, Camping, Midnight Cycling
  {
    ...
    image: '/images/packages/harihar_fort_trek.png',
    rating: 4.8,
    reviews: 154,
    duration: 1,
    price: 1399,
  ...
  },
  {
    ...
    image: '/images/packages/harishchandragad_trek.png',
    rating: 4.9,
    reviews: 210,
    duration: 2,
    price: 2499,
  ...
  },
  {
    ...
    image: '/images/packages/pawna_lake_camping.png',
    rating: 4.7,
    reviews: 98,
    duration: 2,
    price: 1799,
  ...
  },
  {
    ...
    destination: 'Lonavala, Maharashtra',
    image: '/images/packages/rajmachi_fort_trek.png',
    rating: 4.6,
    reviews: 120,
    duration: 2,
    price: 1999,
